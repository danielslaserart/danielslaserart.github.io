...
import { getPriceLadderData, renderPriceLadder } from "./price-ladder.js?v=6.6.4";
...
import { renderProjectPositions, bindProjectPositions, deductPositionStock, positionTotals } from "./project-positions.js?v=6.5.5";
