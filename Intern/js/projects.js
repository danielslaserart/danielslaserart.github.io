import { $, num, euro, uid, esc, compressProjectImage } from "./utils.js?v=6.8";
import { state, save, getRealProjects, getReferenceProjects } from "./storage.js?v=6.8";
import { loadCalculatorData, updateHome, createTemplateFromProject, startNewOrder } from "./ui.js?v=6.8";
import { resolveMaterialSelection } from "./materials.js?v=6.8";
import { workshopUnit, computePriceRecommendations, paintingSurcharge } from "./calculator.js?v=6.8";
import { deleteLearningRecord, saveLearningRecord } from "./learning.js?v=6.8";
import { appAlert, appConfirm, appForm } from "./dialogs.js?v=6.8";
import { priceAgreementHtml, bindPriceAgreementActions } from "./customer-price-history.js?v=6.8";
import { projectFieldLabel, formatProjectFieldValue, isEmptyProjectValue, getCostCoveringMinimumPrice } from "./project-detail-formatting.js?v=6.8";
import { getPriceLadderData, renderPriceLadder } from "./price-ladder.js?v=6.8";
import { renderWorkshopAnalysis } from "./workshop-analysis.js?v=6.8";
import { OFFER_PDF_TEMPLATE, createOfferPdf, downloadOfferPdf, offerPdfFilename } from "./offer-pdf.js?v=6.8";
import { customerNameById, customerAddressById } from "./customers.js?v=6.8";
import { renderProjectPositions, bindProjectPositions, deductPositionStock, positionTotals } from "./project-positions.js?v=6.8";
