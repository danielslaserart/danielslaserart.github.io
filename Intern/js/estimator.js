...
if($('mcSaveProject'))$('mcSaveProject').onclick=async()=>{
  ...
  const agreementFields=existing?{}:{agreementPrice:confirmedPrice,priceAgreementDate:now,isPreferredCustomerPrice:false,agreementPriceNote:"",agreementPriceCreatedAt:now};
