import { $, num, euro, esc, uid } from "./utils.js?v=7.2";
import { state, save } from "./storage.js?v=7.2";
import { materialSelections, resolveMaterialSelection } from "./materials.js?v=7.2";
import { rounded, computePriceBreakdown, computePriceRecommendations, paintingSurcharge, glueSurcharge } from "./calculator.js?v=7.2";
import { getPriceLadderData, renderPriceLadder } from "./price-ladder.js?v=7.2";
import { findSimilarProjects, learnedTimeFactor, learnedPriceSuggestion, saveLearningRecord } from "./learning.js?v=7.2";
import { appAlert, appForm, appConfirm } from "./dialogs.js?v=7.2";
import { renderMotifProfiles } from "./processing-profiles.js?v=7.2";
