import { $, num, euro, esc, uid } from "./utils.js?v=6.6.28";
import { state, save } from "./storage.js?v=6.6.28";
import { materialSelections, resolveMaterialSelection } from "./materials.js?v=6.6.28";
import { rounded, computePriceBreakdown, computePriceRecommendations } from "./calculator.js?v=6.6.28";
import { getPriceLadderData, renderPriceLadder } from "./price-ladder.js?v=6.6.28";
import { findSimilarProjects, learnedTimeFactor, learnedPriceSuggestion, saveLearningRecord } from "./learning.js?v=6.6.28";
import { appAlert, appForm, appConfirm } from "./dialogs.js?v=6.6.28";
import { renderMotifProfiles } from "./processing-profiles.js?v=6.6.28";
