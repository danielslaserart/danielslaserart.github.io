import { $, num, euro, esc, uid } from "./utils.js?v=6.6.32";
import { state, save } from "./storage.js?v=6.6.32";
import { materialSelections, resolveMaterialSelection } from "./materials.js?v=6.6.32";
import { rounded, computePriceBreakdown, computePriceRecommendations } from "./calculator.js?v=6.6.32";
import { getPriceLadderData, renderPriceLadder } from "./price-ladder.js?v=6.6.32";
import { findSimilarProjects, learnedTimeFactor, learnedPriceSuggestion, saveLearningRecord } from "./learning.js?v=6.6.32";
import { appAlert, appForm, appConfirm } from "./dialogs.js?v=6.6.32";
import { renderMotifProfiles } from "./processing-profiles.js?v=6.6.32";
