import { $, num, uid, inferMaterialCategory } from "./utils.js?v=6.6.33";
import { appConfirm } from "./dialogs.js?v=6.6.33";
import { buildMonitoringSnapshot, monitoringSnapshotHasPrivateFields } from "./monitoring.js?v=6.6.33";
