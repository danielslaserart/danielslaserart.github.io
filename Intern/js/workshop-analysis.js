import { $, euro, esc, inferMaterialCategory, num } from "./utils.js?v=7.2";
import { state, getRealProjects } from "./storage.js?v=7.2";
import { getPriceLadderData } from "./price-ladder.js?v=7.2";
