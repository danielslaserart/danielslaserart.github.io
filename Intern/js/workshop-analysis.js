import { $, euro, esc, inferMaterialCategory, num } from "./utils.js?v=6.7";
import { state, getRealProjects } from "./storage.js?v=6.7";
import { getPriceLadderData } from "./price-ladder.js?v=6.7";
