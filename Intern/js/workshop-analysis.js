import { $, euro, esc, inferMaterialCategory, num } from "./utils.js?v=6.6.35";
import { state, getRealProjects } from "./storage.js?v=6.6.35";
import { getPriceLadderData } from "./price-ladder.js?v=6.6.35";
