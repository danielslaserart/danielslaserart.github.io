import { $, num, euro, uid, esc, MATERIAL_CATEGORIES, inferMaterialCategory, inferMaterialUseCategory, inferMaterialActivities, categoryOptions, compressProjectImage } from "./utils.js?v=6.6.19";
import { state, save } from "./storage.js?v=6.6.19";
import { calculate } from "./calculator.js?v=6.6.19";
import { appAlert, appConfirm, appForm } from "./dialogs.js?v=6.6.19";
import { renderMaterialProfileSections, renderMaterialProfileEditor, renderProcessingProfileManager } from "./processing-profiles.js?v=6.6.19";
