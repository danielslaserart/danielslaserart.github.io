import { initializeAuth, state } from "./storage.js?v=4.7";
import { num } from "./utils.js?v=4.7";
import { updateHome, loadCalculatorData, startNewOrder } from "./ui.js?v=4.7";
import { renderCalculator } from "./calculator.js?v=4.7";
import { renderTools } from "./statistics.js?v=4.7";
import { renderMaterialCategoryFilter, renderMaterials, updateMaterialModeButtons } from "./materials.js?v=4.7";
import { renderProjects } from "./projects.js?v=4.7";
import { fillSettings } from "./settings.js?v=4.7";
import { renderMotifEstimator, loadProjectIntoMotifEstimator } from "./estimator.js?v=4.7";
import { applyDesignDefaults, renderDesignStatistics } from "./design.js?v=4.7";
import { initializeProcessingProfiles, renderProcessingProfileManager, renderCalculatorProfiles, renderMotifProfiles } from "./processing-profiles.js?v=4.7";
import { initializeWorkshopAnalysis, renderWorkshopAnalysis } from "./workshop-analysis.js?v=4.7";
import { initializeCustomers, renderCustomers } from "./customers.js?v=4.7";
import "./position-profile-fix.js?v=4.7";

const loadPositionUiFix=()=>import("./position-ui-fix.js?v=4.7").catch(error=>console.warn("Positions-UI-Zusatz konnte nicht geladen werden:",error));
...
export function initializeApp(){
  ...
  if("serviceWorker" in navigator){
    window.addEventListener("load",()=>navigator.serviceWorker.register("sw.js?v=4.7",{updateViaCache:"none"}).catch(()=>{}));
  }
}
