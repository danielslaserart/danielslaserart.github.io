import { initializeAuth, state } from "./storage.js?v=6.6.29";
import { num } from "./utils.js?v=6.6.29";
import { updateHome, loadCalculatorData, startNewOrder } from "./ui.js?v=6.6.29";
import { renderCalculator } from "./calculator.js?v=6.6.29";
import { renderTools } from "./statistics.js?v=6.6.29";
import { renderMaterialCategoryFilter, renderMaterials, updateMaterialModeButtons } from "./materials.js?v=6.6.29";
import { renderProjects } from "./projects.js?v=6.6.29";
import { fillSettings } from "./settings.js?v=6.6.29";
import { renderMotifEstimator, loadProjectIntoMotifEstimator } from "./estimator.js?v=6.6.29";
import { applyDesignDefaults, renderDesignStatistics } from "./design.js?v=6.6.29";
import { initializeProcessingProfiles, renderProcessingProfileManager, renderCalculatorProfiles, renderMotifProfiles } from "./processing-profiles.js?v=6.6.29";
import { initializeWorkshopAnalysis, renderWorkshopAnalysis } from "./workshop-analysis.js?v=6.6.29";
import { initializeCustomers, renderCustomers } from "./customers.js?v=6.6.29";
import "./position-profile-fix.js?v=6.6.29";

const loadPositionUiFix=()=>import("./position-ui-fix.js?v=6.6.29").catch(error=>console.warn("Positions-UI-Zusatz konnte nicht geladen werden:",error));
...
export function initializeApp(){
  ...
  if("serviceWorker" in navigator){
    window.addEventListener("load",()=>navigator.serviceWorker.register("sw.js?v=6.6.29",{updateViaCache:"none"}).catch(()=>{}));
  }
}
