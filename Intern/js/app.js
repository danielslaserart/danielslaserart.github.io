import { initializeAuth, state } from "./storage.js?v=6.4.5";
import { updateHome, loadCalculatorData, startNewOrder } from "./ui.js?v=6.4.5";
import { renderCalculator } from "./calculator.js?v=6.4.5";
import { renderTools } from "./statistics.js?v=6.4.5";
import { renderMaterialCategoryFilter, renderMaterials, updateMaterialModeButtons } from "./materials.js?v=6.4.5";
import { renderProjects } from "./projects.js?v=6.4.5";
import { fillSettings } from "./settings.js?v=6.4.5";
import { renderMotifEstimator, loadProjectIntoMotifEstimator } from "./estimator.js?v=6.4.5";
import { applyDesignDefaults, renderDesignStatistics } from "./design.js?v=6.4.5";
import { initializeProcessingProfiles, renderProcessingProfileManager, renderCalculatorProfiles, renderMotifProfiles } from "./processing-profiles.js?v=6.4.5";
import { initializeWorkshopAnalysis, renderWorkshopAnalysis } from "./workshop-analysis.js?v=6.4.5";
import { initializeCustomers, renderCustomers } from "./customers.js?v=6.4.5";
...
export function initializeApp(){
  ...
  if("serviceWorker" in navigator){
    window.addEventListener("load",()=>navigator.serviceWorker.register("sw.js?v=6.4.5",{updateViaCache:"none"}).catch(()=>{}));
  }
}
