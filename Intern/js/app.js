import { initializeAuth, state } from "./storage.js?v=6.6.28";
import { num } from "./utils.js?v=6.6.28";
import { updateHome, loadCalculatorData, startNewOrder } from "./ui.js?v=6.6.28";
import { renderCalculator } from "./calculator.js?v=6.6.28";
import { renderTools } from "./statistics.js?v=6.6.28";
import { renderMaterialCategoryFilter, renderMaterials, updateMaterialModeButtons } from "./materials.js?v=6.6.28";
import { renderProjects } from "./projects.js?v=6.6.28";
import { fillSettings } from "./settings.js?v=6.6.28";
import { renderMotifEstimator, loadProjectIntoMotifEstimator } from "./estimator.js?v=6.6.28";
import { applyDesignDefaults, renderDesignStatistics } from "./design.js?v=6.6.28";
import { initializeProcessingProfiles, renderProcessingProfileManager, renderCalculatorProfiles, renderMotifProfiles } from "./processing-profiles.js?v=6.6.28";
import { initializeWorkshopAnalysis, renderWorkshopAnalysis } from "./workshop-analysis.js?v=6.6.28";
import { initializeCustomers, renderCustomers } from "./customers.js?v=6.6.28";
import "./position-profile-fix.js?v=6.6.28";

const loadPositionUiFix=()=>import("./position-ui-fix.js?v=6.6.28").catch(error=>console.warn("Positions-UI-Zusatz konnte nicht geladen werden:",error));
...
export function initializeApp(){
  ...
  if("serviceWorker" in navigator){
    window.addEventListener("load",()=>navigator.serviceWorker.register("sw.js?v=6.6.28",{updateViaCache:"none"}).catch(()=>{}));
  }
}
