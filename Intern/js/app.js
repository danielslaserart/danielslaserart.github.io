import { initializeAuth, state } from "./storage.js?v=6.6.21";
import { num } from "./utils.js?v=6.6.21";
import { updateHome, loadCalculatorData, startNewOrder } from "./ui.js?v=6.6.21";
import { renderCalculator } from "./calculator.js?v=6.6.21";
import { renderTools } from "./statistics.js?v=6.6.21";
import { renderMaterialCategoryFilter, renderMaterials, updateMaterialModeButtons } from "./materials.js?v=6.6.21";
import { renderProjects } from "./projects.js?v=6.6.21";
import { fillSettings } from "./settings.js?v=6.6.21";
import { renderMotifEstimator, loadProjectIntoMotifEstimator } from "./estimator.js?v=6.6.21";
import { applyDesignDefaults, renderDesignStatistics } from "./design.js?v=6.6.21";
import { initializeProcessingProfiles, renderProcessingProfileManager, renderCalculatorProfiles, renderMotifProfiles } from "./processing-profiles.js?v=6.6.21";
import { initializeWorkshopAnalysis, renderWorkshopAnalysis } from "./workshop-analysis.js?v=6.6.21";
import { initializeCustomers, renderCustomers } from "./customers.js?v=6.6.21";
import "./position-profile-fix.js?v=6.6.21";

const loadPositionUiFix=()=>import("./position-ui-fix.js?v=6.6.21").catch(error=>console.warn("Positions-UI-Zusatz konnte nicht geladen werden:",error));
...
export function initializeApp(){
  ...
  if("serviceWorker" in navigator){
    window.addEventListener("load",()=>navigator.serviceWorker.register("sw.js?v=6.6.21",{updateViaCache:"none"}).catch(()=>{}));
  }
}
