...
import { initializeProcessingProfiles, renderProcessingProfileManager, renderCalculatorProfiles, renderMotifProfiles } from "./processing-profiles.js?v=6.6.16";
import { initializeWorkshopAnalysis, renderWorkshopAnalysis } from "./workshop-analysis.js?v=6.6.16";
import { initializeCustomers, renderCustomers } from "./customers.js?v=6.6.16";
import "./position-profile-fix.js?v=6.6.16";

const loadPositionUiFix=()=>import("./position-ui-fix.js?v=6.6.16").catch(error=>console.warn("Positions-UI-Zusatz konnte nicht geladen werden:",error));
...
export function initializeApp(){
  ...
  if("serviceWorker" in navigator){
    window.addEventListener("load",()=>navigator.serviceWorker.register("sw.js?v=6.6.16",{updateViaCache:"none"}).catch(()=>{}));
  }
}
