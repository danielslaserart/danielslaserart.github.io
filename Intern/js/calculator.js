...
export function syncAutomaticFirstPosition(module=state.activeModule){
  ...
  calculatorPositionProject.positions[0]=normalizePosition({...first,activity:activityForModule(module),materialId:"",variantId:"",materialName:"",machineId:"",machineName:"",profileId:"",profileName:"",materialCost:0,machineMinutes:0,machineCost:0,printGrams:0},0);
  renderCalculatorProjectPositions();
}
