...
import { renderProjectPositions, bindProjectPositions, projectPositions, normalizePosition, positionTotals } from "./project-positions.js?v=6.5.3";
...
function buildCalculationSnapshot({breakdown,sale,cost,machine,orderType,customerProcess}){
  ...
  return {
    ...
    fields:captureCalculatorFields(),
