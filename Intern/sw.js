const CACHE="dla-kalkulator-v3-2-1-20260725";
const FALLBACK="./index.html?v=3.2.1";
const ASSETS=["./?v=3.2.1","./index.html?v=3.2.1","./style.css?v=3.2.1","./app.js?v=3.2.1","./manifest.json?v=3.2.1","./icon-192.png?v=3.2.1","./icon-512.png?v=3.2.1","./icon-maskable-512.png?v=3.2.1","./briefkopf-logo.png?v=3.2.1","/assets/images/hero/background.webp"];
