...
const FALLBACK="./index.html?v=3.3.1";
const ASSETS=["./?v=3.3.1","./index.html?v=3.3.1","./style.css?v=3.3.1","./app.js?v=3.3.1","./manifest.json?v=3.3.1","./icon-192.png?v=3.3.1","./icon-512.png?v=3.3.1","./icon-maskable-512.png?v=3.3.1","./briefkopf-logo.png?v=3.3.1","/assets/images/hero/background.webp"];
