const CACHE="dla-kalkulator-v3-3-0-20260726";
const FALLBACK="./index.html?v=3.3.0";
const ASSETS=["./?v=3.3.0","./index.html?v=3.3.0","./style.css?v=3.3.0","./app.js?v=3.3.0","./manifest.json?v=3.3.0","./icon-192.png?v=3.3.0","./icon-512.png?v=3.3.0","./icon-maskable-512.png?v=3.3.0","./briefkopf-logo.png?v=3.3.0","/assets/images/hero/background.webp"];
