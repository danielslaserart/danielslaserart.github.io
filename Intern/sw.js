...
const FALLBACK="./index.html?v=3.3.2";
const ASSETS=["./?v=3.3.2","./index.html?v=3.3.2","./style.css?v=3.3.2","./app.js?v=3.3.2","./manifest.json?v=3.3.2","./icon-192.png?v=3.3.2","./icon-512.png?v=3.3.2","./icon-maskable-512.png?v=3.3.2","./briefkopf-logo.png?v=3.3.2","/assets/images/hero/background.webp"];
