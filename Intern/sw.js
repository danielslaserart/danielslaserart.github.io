...
const FALLBACK="./index.html?v=3.3.3";
const ASSETS=["./?v=3.3.3","./index.html?v=3.3.3","./style.css?v=3.3.3","./app.js?v=3.3.3","./manifest.json?v=3.3.3","./icon-192.png?v=3.3.3","./icon-512.png?v=3.3.3","./icon-maskable-512.png?v=3.3.3","./briefkopf-logo.png?v=3.3.3","/assets/images/hero/background.webp"];
