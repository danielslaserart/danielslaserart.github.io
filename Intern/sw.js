const CACHE="dla-kalkulator-v3-1-2-20260725";
const FALLBACK="./index.html?v=3.1.2";
const ASSETS=[
  "./?v=3.1.2",
  "./index.html?v=3.1.2",
  "./style.css?v=3.1.2",
  ...
  "./icon-192.png?v=3.1.2",
  "./icon-512.png?v=3.1.2",
  "./icon-maskable-512.png?v=3.1.2",
  "./briefkopf-logo.png?v=3.1.2",
